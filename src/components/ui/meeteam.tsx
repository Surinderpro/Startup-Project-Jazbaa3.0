  ...
  return (
    <div className="max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
        ...
        <div className="text-center">
          <img className="rounded-full size-24 mx-auto" src="/surinder.jpg" alt="Surinder Jungral" />
          <div className="mt-2 sm:mt-4">
            <h3 className="font-medium text-gray-800 dark:text-neutral-200">Surinder Jungral</h3>
            <p className="text-sm text-gray-600 dark:text-neutral-400">Co-Founder & CTO</p>
          </div>
        </div>
        {/* End Col */}

        <div className="text-center">
          <img className="rounded-full size-24 mx-auto" src="/gungun.jpg" alt="Avdesh Kalra" />
          <div className="mt-2 sm:mt-4">
            <h3 className="font-medium text-gray-800 dark:text-neutral-200">Gunjun Matha</h3>
            <p className="text-sm text-gray-600 dark:text-neutral-400">CMO</p>
          </div>
        </div>
        {/* End Col */}
      </div>
